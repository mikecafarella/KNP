...
def step2(_):
    ...
    VAR_ID_GIVEN_BY_USER1 = "http://lasagna.eecs.umich.edu:5000/var/0"
    TRAIN_LENGTH = 20
    ...
    myval = kgpl.value(rst,val_comment,"Predictor",[VAR_ID_GIVEN_BY_USER1,])
    myvar = kgpl.variable(myval,var_comment,"Predictor")
